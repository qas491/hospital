...
// 患者缴费表 his_patient_payment
type HisPatientPayment struct {
	PaymentID     string     `gorm:"column:payment_id;primaryKey" json:"payment_id"`
	CoID          string     `gorm:"column:co_id" json:"co_id"`                   // 关联处方ID
	PatientID     string     `gorm:"column:patient_id" json:"patient_id"`         // 患者ID
	PatientName   string     `gorm:"column:patient_name" json:"patient_name"`     // 患者姓名
	DoctorID      int64      `gorm:"column:doctor_id" json:"doctor_id"`           // 开方医生ID
	DoctorName    string     `gorm:"column:doctor_name" json:"doctor_name"`       // 开方医生姓名
	PaymentAmount float64    `gorm:"column:payment_amount" json:"payment_amount"` // 缴费金额
	PaymentTime   *time.Time `gorm:"column:payment_time" json:"payment_time"`     // 缴费时间
	PaymentStatus string     `gorm:"column:payment_status" json:"payment_status"` // 缴费状态：success/failed
	PaymentMethod string     `gorm:"column:payment_method" json:"payment_method"` // 缴费方式
	CreateTime    *time.Time `gorm:"column:create_time" json:"create_time"`
	UpdateTime    *time.Time `gorm:"column:update_time" json:"update_time"`
	CreateBy      string     `gorm:"column:create_by" json:"create_by"`
	UpdateBy      string     `gorm:"column:update_by" json:"update_by"`
...
func (HisPatientPayment) TableName() string {
	return "his_patient_payment"
}

// 业绩规则表 his_performance_rule
type HisPerformanceRule struct {
	RuleID        int64      `gorm:"column:rule_id;primaryKey;autoIncrement" json:"rule_id"`
	RuleName      string     `gorm:"column:rule_name" json:"rule_name"`           // 规则名称
	RuleType      string     `gorm:"column:rule_type" json:"rule_type"`           // 规则类型：percentage/fixed
	RuleValue     float64    `gorm:"column:rule_value" json:"rule_value"`         // 规则值：百分比或固定金额
	MinAmount     float64    `gorm:"column:min_amount" json:"min_amount"`         // 最小金额
	MaxAmount     float64    `gorm:"column:max_amount" json:"max_amount"`         // 最大金额
	DeptID        int64      `gorm:"column:dept_id" json:"dept_id"`               // 适用科室ID
	CoType        string     `gorm:"column:co_type" json:"co_type"`               // 适用处方类型
	Status        string     `gorm:"column:status" json:"status"`                 // 状态：active/inactive
	EffectiveDate *time.Time `gorm:"column:effective_date" json:"effective_date"` // 生效日期
	ExpiryDate    *time.Time `gorm:"column:expiry_date" json:"expiry_date"`       // 失效日期
	CreateTime    *time.Time `gorm:"column:create_time" json:"create_time"`
	UpdateTime    *time.Time `gorm:"column:update_time" json:"update_time"`
	CreateBy      string     `gorm:"column:create_by" json:"create_by"`
	UpdateBy      string     `gorm:"column:update_by" json:"update_by"`
...
func (HisPerformanceRule) TableName() string {
	return "his_performance_rule"
}

// 业绩明细表 his_performance_detail
type HisPerformanceDetail struct {
	PerformanceID     string     `gorm:"column:performance_id;primaryKey" json:"performance_id"`
	CoID              string     `gorm:"column:co_id" json:"co_id"`                           // 关联处方ID
	PaymentID         string     `gorm:"column:payment_id" json:"payment_id"`                 // 关联缴费ID
	DoctorID          int64      `gorm:"column:doctor_id" json:"doctor_id"`                   // 开方医生ID
	DoctorName        string     `gorm:"column:doctor_name" json:"doctor_name"`               // 开方医生姓名
	DeptID            int64      `gorm:"column:dept_id" json:"dept_id"`                       // 科室ID
	DeptName          string     `gorm:"column:dept_name" json:"dept_name"`                   // 科室名称
	PaymentAmount     float64    `gorm:"column:payment_amount" json:"payment_amount"`         // 缴费金额
	PerformanceRate   float64    `gorm:"column:performance_rate" json:"performance_rate"`     // 业绩比例
	PerformanceAmount float64    `gorm:"column:performance_amount" json:"performance_amount"` // 业绩金额
	RuleID            int64      `gorm:"column:rule_id" json:"rule_id"`                       // 关联业绩规则ID
	PerformanceDate   *time.Time `gorm:"column:performance_date" json:"performance_date"`     // 业绩计算日期
	WeekStart         *time.Time `gorm:"column:week_start" json:"week_start"`                 // 周开始日期
	WeekEnd           *time.Time `gorm:"column:week_end" json:"week_end"`                     // 周结束日期
	CreateTime        *time.Time `gorm:"column:create_time" json:"create_time"`
	UpdateTime        *time.Time `gorm:"column:update_time" json:"update_time"`
	CreateBy          string     `gorm:"column:create_by" json:"create_by"`
	UpdateBy          string     `gorm:"column:update_by" json:"update_by"`
...
func (HisPerformanceDetail) TableName() string {
	return "his_performance_detail"
}

// 周排行榜表 his_weekly_ranking
type HisWeeklyRanking struct {
	RankingID         string     `gorm:"column:ranking_id;primaryKey" json:"ranking_id"`
	DoctorID          int64      `gorm:"column:doctor_id" json:"doctor_id"`                   // 医生ID
	DoctorName        string     `gorm:"column:doctor_name" json:"doctor_name"`               // 医生姓名
	DeptID            int64      `gorm:"column:dept_id" json:"dept_id"`                       // 科室ID
	DeptName          string     `gorm:"column:dept_name" json:"dept_name"`                   // 科室名称
	WeekStart         *time.Time `gorm:"column:week_start" json:"week_start"`                 // 周开始日期
	WeekEnd           *time.Time `gorm:"column:week_end" json:"week_end"`                     // 周结束日期
	TotalPerformance  float64    `gorm:"column:total_performance" json:"total_performance"`   // 周总业绩
	Rank              int        `gorm:"column:rank" json:"rank"`                             // 排名
	PrescriptionCount int        `gorm:"column:prescription_count" json:"prescription_count"` // 处方数量
	CreateTime        *time.Time `gorm:"column:create_time" json:"create_time"`
	UpdateTime        *time.Time `gorm:"column:update_time" json:"update_time"`
}

func (HisWeeklyRanking) TableName() string {
	return "his_weekly_ranking"
}
